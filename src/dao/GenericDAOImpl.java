...
public class GenericDAOImpl implements IGenericDAO {
	...
	public EntityManager getEm() {
		...
		return dao.Database.getInstance().getEntityManager();
	 ...
	 */
	/* (non-Javadoc)
	 * @see dao.IGenericDAO#create(ObjetoPersistivel)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see dao.IGenericDAO#update(ObjetoPersistivel)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see dao.IGenericDAO#createOrUpdate(ObjetoPersistivel)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see dao.IGenericDAO#delete(ObjetoPersistivel)
	 */
	@Override
	 ...
	 * um determinado valor de coluna. Não precisa ser valor exato. s
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	public void update(String sql) {
		Session session = (Session) dao.Database.getInstance().getEntityManager().getDelegate();
