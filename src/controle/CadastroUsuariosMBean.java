...
/** 
 * MBean que controla operações relacionadas à criação/edição de usuários.
...
@ManagedBean
@SessionScoped
public class CadastroUsuariosMBean extends ControleAbstrato {
	...
	/** Essa é a parte do codigo que serve para adicionar a imagem ao banco de dados
	 * no entanto não sabemos como conectar as duas classes para isso.
	 */
